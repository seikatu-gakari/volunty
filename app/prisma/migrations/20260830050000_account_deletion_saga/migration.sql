CREATE TABLE "t_account_deletion_request" (
...
ON "t_account_deletion_request"("user_id");

CREATE INDEX "t_account_deletion_request_created_at_idx"
ON "t_account_deletion_request"("created_at");

REVOKE ALL ON TABLE "t_account_deletion_request" FROM anon, authenticated;
