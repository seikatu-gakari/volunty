...
const PHOTO_RADIUS = "rounded-[34%_66%_40%_60%/30%_22%_78%_70%]";
...
export function HeroPhotoFrame() {
  ...
  return (
    <div
      ...
      className={`relative mx-auto w-full max-w-[680px] overflow-visible border-[6px] border-white bg-white p-1.5 shadow-xl ring-1 ring-card-border sm:p-2 ${PHOTO_RADIUS}`}
    >
      <div
      ...
      >
        <Image
          alt={photo.alt}
          className={`aspect-[4/3] w-full object-cover ${PHOTO_RADIUS}`}
          height={photo.height}
          priority
