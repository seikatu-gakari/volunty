...
const TYPES = [
  { name: "縁の下の力持ちタイプ", scores: { 外向性: 32, 協調性: 70, 誠実性: 90, 開放性: 52 }, activity: "資料整理・受付サポート", match: 91, gradient: "from-orange-50 to-amber-50", accent: "#fb5b01" },
  { name: "リーダータイプ",       scores: { 外向性: 88, 協調性: 66, 誠実性: 74, 開放性: 70 }, activity: "地域イベントの運営スタッフ", match: 93, gradient: "from-red-50 to-orange-50", accent: "#ef4444" },
  { name: "アイデアマンタイプ",   scores: { 外向性: 78, 協調性: 86, 誠実性: 64, 開放性: 92 }, activity: "子ども向け工作ワークショップ", match: 94, gradient: "from-purple-50 to-violet-50", accent: "#8b5cf6" },
  { name: "実行力タイプ",         scores: { 外向性: 70, 協調性: 58, 誠実性: 82, 開放性: 60 }, activity: "河川敷の清掃・緑化活動", match: 90, gradient: "from-green-50 to-emerald-50", accent: "#10b981" },
  { name: "サポータータイプ",     scores: { 外向性: 60, 協調性: 92, 誠実性: 76, 開放性: 58 }, activity: "イベント当日のチーム補助", match: 92, gradient: "from-blue-50 to-sky-50", accent: "#3b82f6" },
  { name: "アナリストタイプ",     scores: { 外向性: 40, 協調性: 54, 誠実性: 88, 開放性: 80 }, activity: "活動データの集計・分析", match: 89, gradient: "from-indigo-50 to-blue-50", accent: "#6366f1" },
  { name: "コミュニケータータイプ", scores: { 外向性: 90, 協調性: 80, 誠実性: 62, 開放性: 74 }, activity: "来場者の案内・多言語サポート", match: 93, gradient: "from-yellow-50 to-orange-50", accent: "#f59e0b" },
  { name: "ケアギバータイプ",     scores: { 外向性: 56, 協調性: 94, 誠実性: 78, 開放性: 66 }, activity: "高齢者の見守り・声かけ", match: 95, gradient: "from-pink-50 to-rose-50", accent: "#ec4899" },
];
