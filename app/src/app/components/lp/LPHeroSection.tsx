      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-center lg:gap-x-12 lg:gap-y-7">
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:col-start-1 lg:row-start-2">
          <Link
            ...
            className="inline-flex h-14 items-center justify-center gap-2 rounded-2xl bg-primary-dark px-6 text-base font-bold text-white shadow-lg shadow-primary/15 transition-all hover:-translate-y-0.5 hover:bg-text-dark lg:px-3 lg:text-sm xl:px-6 xl:text-base"
          >
            無料で簡易診断を試す
          ...
          <Link
            href="/opportunities"
            className="inline-flex h-14 items-center justify-center gap-2 rounded-2xl border-2 border-primary-dark bg-white px-6 text-base font-bold text-primary-dark transition-colors hover:bg-primary/5 hover:text-text-dark lg:px-3 lg:text-sm xl:px-6 xl:text-base"
          >
            募集中の活動を見る
            <ArrowRight className="size-5" aria-hidden />
          </Link>
