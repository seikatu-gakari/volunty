      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-[1.25fr_0.75fr]">
        <div className="rounded-[28px] bg-white p-6 shadow-sm ring-1 ring-card-border sm:p-8">
          <div className="mb-6 flex items-center gap-3">
            <span className="flex size-11 items-center justify-center rounded-2xl bg-primary/10 text-text-dark">
              <Sparkles className="size-5" aria-hidden />
            </span>
            <div>
              <p className="text-xs font-bold tracking-[0.14em] text-text-dark">BIG FIVE</p>
