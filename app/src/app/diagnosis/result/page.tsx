...
function ScoreSection({ scores }: { scores: BIG5Scores }) {
  return (
    <div className="space-y-8">
      <h3 className="text-xl font-bold text-text-dark">BIG5 スコア詳細</h3>
      ...
      <div className="mt-8 rounded-lg bg-gray-50 p-4 text-sm text-text-body">
    ...
    <div className="min-h-screen bg-background font-sans">
      ...
      <main className="mx-auto max-w-4xl px-6 py-10">
        ...
        <div className="mb-12 text-center">
          <h2 className="mb-4 text-3xl font-bold text-text-dark">診断結果</h2>
          ...
          <p className="text-xl font-medium text-text-body">{type.nameEn}</p>
        </div>
        ...
        <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          <Link
            ...
            className="flex h-12 items-center gap-2 rounded-lg bg-primary px-8 text-base font-medium text-white hover:bg-primary-dark"
          >
          ...
          <Link
            href="/diagnosis"
            className="flex h-12 items-center gap-2 rounded-lg border border-card-border bg-white px-8 text-base font-medium text-text-dark hover:bg-gray-50"
          >
